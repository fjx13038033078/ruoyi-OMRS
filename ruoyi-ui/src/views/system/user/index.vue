...
<!--          <el-table-column label="部门/班级" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />-->
          ...
          <el-table-column label="身高" align="center" key="height" prop="height" v-if="columns[5].visible" />
          <el-table-column label="所在城市" align="center" key="location" prop="location" v-if="columns[6].visible" :show-overflow-tooltip="true" />
          <el-table-column label="体型" align="center" key="bodyType" v-if="columns[7].visible">
            <template slot-scope="scope">
              <dict-tag :options="dict.type.wardrobe_body_type" :value="scope.row.bodyType"/>
            </template>
          </el-table-column>
...
export default {
  name: "User",
  dicts: ['sys_normal_disable', 'sys_user_sex', 'wardrobe_body_type'],
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 3, label: `部门/班级`, visible: false },
        { key: 4, label: `手机号码`, visible: true },
        { key: 5, label: `身高`, visible: true },
        { key: 6, label: `所在城市`, visible: true },
        { key: 7, label: `体型`, visible: true },
